...
void __cdecl hkPresentWindow(HWND hwnd, int width, int height)
{
    ...
    {
        swg::graphics::presentWindow(hwnd, rect.right - rect.left, rect.bottom - rect.top);
    }
    else
    {
...
void Graphics::detour()
{
    ...
    swg::graphics::presentWindow = (swg::graphics::pPresentWindow)Detour::Create((LPVOID)swg::graphics::presentWindow, hkPresentWindow, DETOUR_TYPE_PUSH_RET);
    swg::graphics::present = (swg::graphics::pPresent)Detour::Create((LPVOID)swg::graphics::present, hkPresent, DETOUR_TYPE_PUSH_RET);
}
...
{
    return *(int*)0x1922E64; // static ptr to RenderTargetWidth
}

int Graphics::getCurrentRenderTargetHeight() // 0x00754DC0 is the clients function address
{
    return *(int*)0x1922E60; // static ptr to RenderTargetHeight
}

void Graphics::flushResources(bool flushAll)
{
    swg::graphics::flushResources(flushAll);
}
